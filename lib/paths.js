...
export const DATA_HOME = resolve(homedir(), 'linkedin-talent');
...
/** 单批次 Review HTML 路径（与 Excel 同目录） */
export function reviewHtmlPath(batchId) {
  return resolve(BATCHES_DIR, `linkedin_${batchId}-review.html`);
}
...
export function ensureDataDirs() {
  for (const d of [DATA_HOME, BATCHES_DIR, CRITERIA_DIR, EXPORTS_DIR, DECISIONS_DIR, ARCHIVE_DIR]) {
