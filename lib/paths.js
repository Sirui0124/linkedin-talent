...
/** Phase 3 提交给 subagent 的评分输入 JSON */
export function phase3SubagentInputPath(batchId) {
  return resolve(EXPORTS_DIR, `phase3_subagent_input_${batchId}.json`);
}

/** Phase 3 subagent 返回的评分结果 JSON */
export function phase3SubagentScoresPath(batchId) {
  return resolve(EXPORTS_DIR, `phase3_subagent_scores_${batchId}.json`);
}
