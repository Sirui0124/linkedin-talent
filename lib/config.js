...
export const COMPANY_ID_MAP = {
  ...
  'NVIDIA': 3608,
  '英伟达': 3608,
  // ⚠️ TSMC ID 待验证：5765440 与 Bilibili / 小米 冲突，首次使用前需运行 findCompanyIdScript('TSMC') 校正后回填
  'TSMC': null,
  '台积电': null,
  'Samsung': 1753,
  '三星': 1753,
...
export function getCompanyId(companyName) {
  return COMPANY_ID_MAP[companyName] || COMPANY_ID_MAP[companyName?.toLowerCase()] || null;
}
